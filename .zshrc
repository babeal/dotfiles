...
for repo in ${plugins[@]}; do
  load_plugin https://github.com/${repo}.git
done
unset repo

if [[ ${OSTYPE} == "darwin"* ]]; then
  for mac_repo in ${mac_plugins[@]}; do
    load_plugin https://github.com/${mac_repo}.git
  done
  unset mac_repo
fi
...
setopt correct                # autocorrect commands | correct_all to correct arguments as well but it's annoying
...
unset REPO_ROOT configFileLocations configFileLocation
